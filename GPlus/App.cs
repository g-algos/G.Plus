...
public class App : IExternalApplication
{
    ...
    internal void CreateRibbon(UIControlledApplication app)
    {
        ...
        string fileVersioning = Base.Resources.Localizations.Content.FileVersioning;
        string extra = "●●●";
        ...
        RibbonPanel fileVersioningPanel = app.CreateRibbonPanel(tabName, fileVersioning);
        PushButtonData versioning = new PushButtonData("FileVersioning", Base.Resources.Localizations.Content.VersionHistory, assemblyPath, typeof(Commands.VersioningCommand).FullName);
        versioning.AvailabilityClassName = typeof(Helpers.Availability.VersioningAvailability).FullName;
        versioning.ToolTip= Base.Resources.Localizations.Content.VersioningToolTip;
        versioning.LargeImage = new BitmapImage(new Uri("pack://application:,,,/GPlus;component/Resources/RibbonButtons/versioning_32.png"));
        versioning.SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://g-algos.com/G.plus/FileVersioning"));

        PushButtonData startVersioning = new PushButtonData("StartVersioning", Base.Resources.Localizations.Content.SaveVersion, assemblyPath, typeof(Commands.StartNewVersionRecordCommand).FullName);
        startVersioning.AvailabilityClassName = typeof(Helpers.Availability.DocumentAvailability).FullName;
        startVersioning.ToolTip = Base.Resources.Localizations.Content.SaveVersionToolip;
        startVersioning.LargeImage = new BitmapImage(new Uri("pack://application:,,,/GPlus;component/Resources/RibbonButtons/start_versioning_32.png"));
        startVersioning.SetContextualHelp(new ContextualHelp(ContextualHelpType.Url, "https://g-algos.com/G.plus/FileVersioning"));
        fileVersioningPanel.AddItem(startVersioning);
        fileVersioningPanel.AddItem(versioning);
